...
export default module('The CreateFolderAction', () => {
    ...
    const stateManagerMock = {
      mutate: (mutator) => {
        ...
        if (mutator instanceof RenameFolderMutator) {
          assert.strictEqual(mutator._folderId, folder.id, 'The CreateFolderAction should provide correct folder ID ' +
            'to the RenameFolderMutator.');
        }
      },
