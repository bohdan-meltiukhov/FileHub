...
export default module('The FileItemComponent', (hooks) => {
  ...
  test('should have the provided properties.', (assert) => {
    ...
    assert.strictEqual(firstAction.className, 'glyphicon glyphicon-download', 'The file item component should show ' +
      'the download action.');
  });
