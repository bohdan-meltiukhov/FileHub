...
export default module('The RemoveCreateFolderInProgressMutator', () => {
  test('should remove the provided folder ID correctly.', (assert) => {
    ...
    assert.deepEqual(Array.from(state.foldersWithCreateFolderInProgress), [], 'The ' +
      'RemoveCreateFolderInProgressMutator should remove the folder ID from the provided state correctly.');
  });
});
